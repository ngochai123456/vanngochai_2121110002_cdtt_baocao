...
@section('title', 'Gấu Bông Hải Shop')
@section('header')
    ...
    <div class=" layout-product container body">
        <div class="row mb-3">
            ...
            <div class="col-md-3 my-2">
                <h4 class="border-bottom py-1 text-uppercase fw-bold">Thông tin </h4>
                <div class="col-md-12 ">
                    <div class="row">
                        <div class="col-6">
                            <p>> Xuất sứ </p>
            ...
            <div class="col-md-4 my-2">
                ...
                <div class="description border rounded-top">
                    <p class="bg-blue text-center rounded-top fs-5 text-white py-1 mb-1">Chi tiết</p>
