...
<section class="body container">
    <div class="row">
        <div class="col-md-6">
            ...
            <p>
                ...
                với nhóm hỗ trợ của HaiShop.</p>

            <h4>{{ $list[1] }}
            </h4>
            <p>Đối với các câu hỏi chung, yêu cầu đối tác, cũng như thông tin liên quan đến phương tiện truyền thông,
                hãy
                liên hệ với Gấu Bông Đẹp</p>
            <h4>{{ $list[2] }}
            </h4>
            <p>Đối với các yêu cầu bán hàng liên hệ với nhóm bán hàng của shop.</p>
        </div>
        <div class="col-md-6">
            <h3>Gửi tin nhắn cho shop
            </h3>
            <p>Các bạn có thông tin cần liên hệ, hoặc cần hợp tác, các bạn có thể liên hệ qua Zalo, Facebook, Fanpage
                hoặc để lại thông tin liên hệ ở đây, shop sẽ liên hệ lại ngay</p>
    ...
    <div class="row mt-5">
        <div class="col-md-6">
            <h4>Shop Chuyên Bán Gấu Bông</h4>
